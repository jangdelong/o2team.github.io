...
cover: "pfan/edge/edgeanimate.jpg"
tags:
  - edge animate
  - html5
  - animate
...
{% pimg pfan/edge/6.jpg %}

## 实例操作
当我们了解以上这些知识点，之后，我们来做一下简单的实例，实现顶部图片我们所看到的界面，人物跑动，背景向前移动。{% pimg pfan/edge/7.jpg %}
...
{% pimg pfan/edge/12.jpg %}
{% pimg pfan/edge/13.png %}
