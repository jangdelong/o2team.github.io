title: Canvas虹膜消除转场
subtitle: 一个基于童年动画记忆的考据之路
cover: iriswipe_cover.jpg
tags:
  - Canvas
  - 转场
  - 触屏页转场
...
loading跟正片背景完全不一样！
整个需求还分成三个阶段：导语部分（开片）、职位介绍部分（正片）、结束部分（字幕）
每个阶段之间的元素少则三四个，多则四五个，如果一个一个地transition，想想都替浏览器觉得卡。
...
{% pimg lyxuncle/iriswipe/slides_pic_s.jpg "Matin馬田120片夾" '{"title":"Matin馬田120片夾","class":"Slides"}' %}
- 图片来源：[无谓艺术-暗房部](https://item.taobao.com/item.htm?spm=a1z0d.6639537.1997196601.4.6PmRAn&id=526140335238)
...
{% pimg lyxuncle/iriswipe/wipe_blackboard.gif "自动擦黑板机" '{"title":"自动擦黑板机","class":"wipe"}' %}
...
消除转场借鉴了舞台表演中幕布的转场形式，并利用电脑剪辑比较自由的优势在幕布上增加了一些形状。在视频这个特殊的媒介中，屏幕被看作银幕世界中的第四面墙。有些影视作品中的角色会与观众对话，称为打破第四面墙，这种做法出现在了美剧纸牌屋中，鼻祖是莎翁的哈姆莱特。

{% pimg lyxuncle/iriswipe/House.Of.Cards.S02E01.jpg "《纸牌屋》" '{"title":"House of Cards","class":""}' %}
- 《纸牌屋》

题外话：虹膜位于眼球眼白与瞳孔之间，阿婆主对于这种转场选用这个命名有点困扰，对于放大缩小这种行为，更为接近的是瞳孔才对。
