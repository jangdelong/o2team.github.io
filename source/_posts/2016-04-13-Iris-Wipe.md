...
cover: http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/iriswipe_cover.png
categories: Web开发
tags:
  - Canvas
  - 转场
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/design.png "需求截图（设计师：吉吉）" '{"title":"design","class":"design"}' %}
- 设计师：吉吉

让我们上上下下打量打量这个需求。

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/omg_yue.gif "我的天哪-小岳岳.gif" '{"title":"omg","class":"omg"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/tom_and_jerry_01_16.gif "汤姆和杰瑞" '{"title":"Tom and Jerry","class":"Iris Slow"}' %}
- 童年的回忆：猫和老鼠
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/ppt_keynote_transition.png "PPT与Keynote中的动效" '{"title":"Transition in PPT and Keynote","class":"Transition"}' %}

再往人生前半段推，小学老师偶尔会用黑白幻灯片来展示一些图案内容，即便是这种形式也有着其独特的转场效果。

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/the_man_from_uncle.gif "[秘密特工]" '{"title":"The Man from U.N.C.L.E","class":"Slides"}' %}
- [秘密特工]

最原始的知识海洋黑板，你可能会说，这可没有转场效果了吧？其实，擦黑板也是一种转场呀。

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/wipe_blackboard.gif "自动擦黑板机" '{"title":"自动擦黑板机","class":"wipe"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/ppt_transition.png "PPT转场与影视转场" '{"title":"PPT transitions","class":"transition"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/barn.jpg "谷仓" '{"title":"PPT barn","class":"wipe"}' %}
- 谷仓

看看维基君给出的浮夸例子

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/wiki_wipes_s.gif "维基百科消除转场示例" '{"title":"WikiPedia Wipes Demo","class":"wipe"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/I_Love_to_Singa.gif "动画短片《我爱唱歌》结尾人物与第四面墙的互动。" '{"title":"I Love to Singa","class":"wipe"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/House.Of.Cards.S02E01.jpg "《纸牌屋》" '{"title":"House of Cards","class":""}' %}
- 《纸牌屋》

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/iris-pupil-anatomy-illustration_medical512.png "虹膜图示" '{"title":"Iris Pupil Anatomy Illustration Medical","class":"iris"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/substract.png "制图工具中的层叠样式" '{"title":"Substract in PS and Sketch3","class":"substract"}' %}

这个图标在大部分的制图软件中都是一个功能，减去上层形状。

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/substract_compare.png "减去顶层形状效果" '{"title":"Substract Comparison","class":"substract"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/mdn_globalcompsiteoperation.png "globalCompositeOperation属性值表" '{"title":"Value of globalCompositeOperation","class":"globalCompositeOperation"}' %}
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/destination-out.png "globalCompositeOperation属性值destination-out" '{"title":"destination-out of globalCompositeOperation","class":"globalCompositeOperation"}' %}

有了这样一个方法，搞出虹膜消除转场简直是分分钟的事。

首先我们来撸一撸我们需要哪些值来进行一个虹膜消除转场的绘制。

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/precious_sketch.png "虹膜消除转场实现构思" '{"title":"Sketch of Canvas Iris Wipe","class":"canvas"}' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/Pythagorean_theorem.png "勾股定理" '{"title":"Pythagorean theorem","class":"canvas"}' %}
- 他们说放个公式会高大上一点。
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/lyxuncle/iriswipe/iris_mobi.gif "虹膜消除转场在需求中的应用" '{"title":"Iris Slow in Subject","class":"canvas"}' %}
