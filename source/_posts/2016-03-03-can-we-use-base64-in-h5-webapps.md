...
cover: http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/cover.jpg
categories: 性能优化
tags:
  - base64
  - h5
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455676041355.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455624301638.png '实例图片' %}

开启缓存状态下，build: 7ms |  complete: 59ms（包括以下稳定状态下多次测试的平均值，截图为最接近平均值的状态，默认数据来自Mac+Chrome[48.XX版本]）

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455624345624.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455629551042.png '实例图片' %}
开启缓存状态下，build: 160ms |  complete: 210ms

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455629572545.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/data1.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/data2.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455634381569.png '实例图片' %}
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455634756427.png '实例图片' %}
开启缓存：build: 110ms |  complete: 120ms

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455634772411.png '实例图片' %}
| 测试环境      |    build(单位:ms) | complete(单位:ms)  |
| :--------: | :--:| :--: |
| OS X+Chrome  | 110 |  120   |
| iOS+微信     |   50|  100  |
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455634859983.png '实例图片' %}

开启缓存：build: 0ms |  complete: 80ms

{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455634882064.png '实例图片' %}
...
| 4G         |   450 | 400 |
| WIFI       |   320 | 340 |
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/data3.png '实例图片' %}
#### 分析和小结：
...
{% pimg http://7xt3gj.com1.z0.glb.clouddn.com/Simbachen/base64/1455635010603.png '实例图片' %}
