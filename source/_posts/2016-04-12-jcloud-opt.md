...
{% pimg mihanX/jcloud-opt/img_31.png %}
...
{% pimg mihanX/jcloud-opt/img_1.jpg %} 
...
{% pimg mihanX/jcloud-opt/img_32.png %} 
...
{% pimg mihanX/jcloud-opt/img_9.png %}
...
{% pimg mihanX/jcloud-opt/img_10.png %}

原来 2MB 的字体

{% pimg mihanX/jcloud-opt/img_12.png %}

生成的字体文件只有 11KB，字体文件体积减少达到了 99%

{% pimg mihanX/jcloud-opt/img_11.png %}
...
{% pimg mihanX/jcloud-opt/img_14.png %}

有些可以合并的图片并没有做处理：

{% pimg mihanX/jcloud-opt/img_16.png %} 
...
{% pimg mihanX/jcloud-opt/img_15.png %}
...
{% pimg mihanX/jcloud-opt/img_17.png %}
...
{% pimg mihanX/jcloud-opt/img_18.png %} 
...
{% pimg mihanX/jcloud-opt/img_19.png %}
...
{% pimg mihanX/jcloud-opt/img_20.png %}
...
{% pimg mihanX/jcloud-opt/img_21.png %}
...
{% pimg mihanX/jcloud-opt/img_24.png %}

当图片加载失败的时候，展示占位图，避免系统默认的图片加载失败图标出现

{% pimg mihanX/jcloud-opt/img_23.png %} 
...
{% pimg mihanX/jcloud-opt/img_25.gif %}

不支持 CSS3 动画的 PoorGuy

{% pimg mihanX/jcloud-opt/img_33.gif %}  
...
{% pimg mihanX/jcloud-opt/img_26.png %} 
...
{% pimg mihanX/jcloud-opt/img_27.png %}

`outline:none`设置之后，页面上的所有链接虽然能通过`Tab`键聚焦，但链接并没有被选中的样式，没有办法直观辨出选中的链接

{% pimg mihanX/jcloud-opt/img_28.gif %}
...
{% pimg mihanX/jcloud-opt/img_29.png %}
...
{% pimg mihanX/jcloud-opt/img_30.gif %}
...
OK，优化永远说不完的，以上所说的只是前端优化的冰山一角，业界绝不缺高大上的优秀优化方案，但从业务实际规模出发的话，这些小优化在本次改版中已得到很明显的收益，期待以后有更具规模的项目可以挥霍高大上的优化方案。