...
cover: http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/banner.png
categories: 其它
tags:
  - Safari 9.0
  - iOS
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/fit.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/notfit.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_8.jpg) 
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_1.jpg)

Update Xcode 到最新版本，打开 Xcode，新建立一个 iOS Single View Application 项目（blocker-demo），如图所示：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_2.jpg)

然后新建立一个 Target，在 Application Extension 模版中选中 Content Blocker Extension：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_3.jpg)

完成之后，就可以在项目中看到刚才新增的 Target 文件夹（blocker），可以找到一个名为 `blockerList.json`的 JSON 文件，在里面就可以配置需要拦截内容的规则了，如图所示：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_4.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_5.jpg)

启动 Safari，打开[拍拍小店首页](http://missoy.me/mihan/h5/shop/index.html)，这时候我们可以看到，启动内容拦截扩展之后，顶部的广告区域被隐藏了

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_6.jpg)

用 Safari 的 Web 检查器看了一下页面，发现用户样式表里针对顶部广告区域多了一个 `display: none !important;`样式

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/blocker_7.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/sys-font-no.png)

添加了 `-apple-system` 属性值：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/sys-font-yes.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/sys-font-qrcode.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/sys-font.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/scroll-snap_9.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/scroll-snap_10.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/initial-letter_2.jpg)
...
> ![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/initial-letter.jpg)

实验 [Demo](http://missoy.me/mihan/demo/initial-letter.html) 如下：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/initial-letter_3.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/filter2.jpg) 

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/filter.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/css4_selector.jpg)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/rdm.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/chrome.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/web_inspector_1.png)

（从苹果开发者文档介绍了解到的，没使用过，目测是 Safari 4.0 or 之前的）

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/web_inspector_2.png)
...
![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/web_inspector_3.png)

元素查看，样式修改调试方便，直接点光标直接处于编辑状态了，不明白 Chrome 的为什么点了默认全选，编辑态还有一个输入框的形态，Apple 的极简设计理念无处不在，处处体现着苹果 Design 的基因

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/web_inspector_4.png)

断点调试器也哗啦啦地好看易用：

![image](http://7xt3gj.com1.z0.glb.clouddn.com/mihanX/safari-9/web_inspector_5.png)
