...
半年多没用ngrok，然后昨天发现它被墙了。这种感觉就好像迅雷的许多动作种子突然不能下载了一样，偶尔想看看不成，幸好非单身，也便懒得去hack各种下载的方法啦！
...
我只提下它的核心功能：能够将你本机的HTTP服务（站点）或TCP服务，通过部署有ngrok服务的外网伺服器暴露给外网访问！
...
4. 在浏览器中输入demo.ngrok.fex.im:8088
  ...
  {% pimg mamboer/ngrok-demo.jpg %}

5. 在浏览器中输入：localhost:4040

  可以查看所有的请求情况！
  {% pimg mamboer/ngrok-demo1.jpg %}
